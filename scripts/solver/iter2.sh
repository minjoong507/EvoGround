OUTDIR="checkpoints/Solver/Qwen2.5-VL-7B-Solver-Iter2"
GEN_DATA_SOURCE="Qwen2.5-VL-7B-Proposer-Iter1"
BASE_MODEL_NAME_OR_PATH="checkpoints/Solver/Qwen2.5-VL-7B-Solver-Iter1"
