...
SOLVER_MODEL_NAME_OR_PATH="checkpoints/Solver/Qwen2.5-VL-7B-Solver-$solver_id"
BASE_PROPOSER_MODEL_NAME_OR_PATH="checkpoints/Proposer/Qwen2.5-VL-7B-Proposer-$base_id"

gradient_accumulation_steps=4
dataset="timer1"

export WANDB_PROJECT=Qwen2.5-VL-Proposer
export WANDB_NAME=Iter2
...
torchrun --nproc_per_node="4" \
    ...
    --run_name $WANDB_NAME \
    --report_to wandb \
    --reward_funcs format_gdpo consistency feedback \
